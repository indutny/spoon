...
Block.prototype.split = function split(at, asyncify) {
  ...
  // Add function declaration to the current block
  this.ended = false;
  var fn = this.add('fn', [ next ]),
      last = this.instructions.pop();
